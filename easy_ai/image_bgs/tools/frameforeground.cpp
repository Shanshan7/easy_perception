...
//得到前景图像
void FrameForeground::getFrameForeground(const cv::Mat& inFrame, cv::Mat& foregroundFrame)
{
    ...
    //背景分割
    bgs->process(inFrame, foregroundFrame, backgroundFrame);
    if (enableMorphology)
    {
